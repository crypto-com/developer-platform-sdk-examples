...
def get_crypto_price(symbol: str) -> str:
    ...
    Args:
        symbol (str): The cryptocurrency symbol (e.g., 'BTC', 'ETH', 'CRO')

    Returns:
        str: Current price information
    """
    # This is a simulation - in reality you'd call a real API
    prices = {"BTC": "$45,000", "ETH": "$3,200", "CRO": "$0.12", "USDC": "$1.00"}

    price = prices.get(symbol.upper(), "Price not available")
    return f"Current {symbol.upper()} price: {price}"
